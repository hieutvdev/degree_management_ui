...
const WareHouse = () => {
  ...
  const handleCreate = () => {
    modals.openConfirmModal({
      title: <Title order={5}>Thêm kho văn bằng</Title>,
      size: "auto",
  ...
  const handleUpdate = (id: string | number) => {
    modals.openConfirmModal({
      title: <Title order={5}>Chỉnh sửa kho văn bằng</Title>,
      size: "auto",
  ...
  const handleDetail = (id: string | number) => {
    modals.openConfirmModal({
      title: <Title order={5}>Chi tiết kho văn bằng</Title>,
      size: "auto",
  ...
  const handleDelete = (id: string | number) => {
    modals.openConfirmModal({
      title: <Title order={5}>Xóa kho văn bằng</Title>,
      size: "auto",
