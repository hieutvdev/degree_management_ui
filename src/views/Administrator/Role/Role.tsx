...
const Role = () => {
  ...
  async function fetchData() {
    ...
    let url = `${API_ROUTER.GET_LIST_ROLE}?PageIndex=${pagination.pageIndex}&PageSize=${pagination.pageSize}`;
  ...
  const handleCreate = () => {
    modals.openConfirmModal({
      title: <Title order={5}>Thêm chức danh</Title>,
      size: "auto",
  ...
  const handleUpdate = (id: string | number) => {
    modals.openConfirmModal({
      title: <Title order={5}>Chỉnh sửa chức danh</Title>,
      size: "auto",
  ...
  const handleDetail = (id: string | null) => {
    modals.openConfirmModal({
      title: <Title order={5}>Chi tiết chức danh</Title>,
      size: "auto",
